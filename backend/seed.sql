-- ============================================================
-- 食べカー Ver1.0 テストデータ
-- パスワードは全ユーザー共通で password123
-- ============================================================

-- password_hash: bcrypt of "password123"
INSERT INTO users (email, password_hash, display_name, user_type) VALUES
('user01@example.com', '$2b$12$KzTNmu8PjiLgLZYuRFW.uO2B204Zdx7kvI523ZfwtA.Sf2riXqMue', 'テストユーザー01', 'USER'),
('shop01@example.com', '$2b$12$KzTNmu8PjiLgLZYuRFW.uO2B204Zdx7kvI523ZfwtA.Sf2riXqMue', 'クレープSunny担当', 'SHOP'),
('shop02@example.com', '$2b$12$KzTNmu8PjiLgLZYuRFW.uO2B204Zdx7kvI523ZfwtA.Sf2riXqMue', 'からあげ永屋担当', 'SHOP'),
('shop03@example.com', '$2b$12$KzTNmu8PjiLgLZYuRFW.uO2B204Zdx7kvI523ZfwtA.Sf2riXqMue', 'Nara Burger担当', 'SHOP'),
('shop04@example.com', '$2b$12$KzTNmu8PjiLgLZYuRFW.uO2B204Zdx7kvI523ZfwtA.Sf2riXqMue', 'Tokyo Taco担当', 'SHOP'),
('admin@example.com', '$2b$12$KzTNmu8PjiLgLZYuRFW.uO2B204Zdx7kvI523ZfwtA.Sf2riXqMue', '管理者', 'ADMIN');
